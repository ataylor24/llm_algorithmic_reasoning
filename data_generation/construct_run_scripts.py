...
def generate_run_scripts(alg, sizes, base_path, reasoning_strategy):
    outer_directory = os.path.join(base_path, 'alg_run_scripts')
    os.makedirs(outer_directory, exist_ok=True)
    
    directory = os.path.join(outer_directory, f"{alg}_{reasoning_strategy}_scripts")
...
if __name__ == "__main__":
    ...
    generate_run_scripts(args.alg, args.sizes, args.base_path, args.reasoning_strategy)
