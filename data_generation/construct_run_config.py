...
parser.add_argument('--chat_type', type=str, default="chat_rerun_ralpha_8", help="chat (llama) or chat_mistral (mistral)")
parser.add_argument('--r_alpha', type=int, default=8, help="chat (llama) or chat_mistral (mistral)")
...
for graph_size in graph_sizes:
    ...
    config['lora_alpha'] = r_alpha
    config['lora_r'] = r_alpha
